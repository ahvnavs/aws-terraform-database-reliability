...
resource "aws_route_table" "pub_route" {
  ...
  tags = { Name = "${var.env}-public-route-table" }
}
...
resource "aws_route_table" "pri_route" {
  ...
  tags = { Name = "${var.env}-private-route-table" }
}
